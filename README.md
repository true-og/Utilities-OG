...
* **NoFlippy:** Honors WorldGuard's `can-flippy` flag: DENY blocks trapdoors and fence gates, ALLOW explicitly permits them, and an unset flag preserves normal protection (Requires WorldGuard plugin).
