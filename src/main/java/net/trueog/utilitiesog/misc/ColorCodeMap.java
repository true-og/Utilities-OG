...
// Declare a Class to help convert back and forth between legacy Bukkit color / formatting codes and modern MiniMessage
...
public class ColorCodeMap {
    ...
    public static String toMiniMessage(char legacyCode) {
        ...
        // the Hash Map.
        final String miniMessageCode = CODE_MAP.get(legacyCode);
