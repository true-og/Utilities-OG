...
public class ChainArmorModule {
    ...
    public static void Enable() {
        ...
        final ShapedRecipe ChainHelmet = new ShapedRecipe(new NamespacedKey(Internal.getPlugin(), "Chainmail_Helmet1"),
        ...
        final ShapedRecipe ChainChestPlate = new ShapedRecipe(
                new NamespacedKey(Internal.getPlugin(), "Chainmail_Chestplate"),
        ...
        final ShapedRecipe ChainLeggings = new ShapedRecipe(
                new NamespacedKey(Internal.getPlugin(), "Chainmail_Leggings"),
                new ItemStack(Material.CHAINMAIL_LEGGINGS)).shape("ccc", "c c", "c c")
                .setIngredient('c', Material.CHAIN);

        // Defines a crafting recipe for Chainmail Boots from Chains.
        final ShapedRecipe ChainBoots = new ShapedRecipe(new NamespacedKey(Internal.getPlugin(), "Chainmail_Boots1"),
