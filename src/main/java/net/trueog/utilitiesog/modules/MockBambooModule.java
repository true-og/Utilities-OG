...
public class MockBambooModule {
    ...
    public static void Enable() {
        ...
        final ShapedRecipe BambooPlanks = new ShapedRecipe(new NamespacedKey(Internal.getPlugin(), "Bamboo_Planks"),
        ...
        final ShapedRecipe imitationBambooWoodRecipe = new ShapedRecipe(
                new NamespacedKey(Internal.getPlugin(), "Imitation_Bamboo_Wood"), imitationBambooWood).shape("bb", "bb")
