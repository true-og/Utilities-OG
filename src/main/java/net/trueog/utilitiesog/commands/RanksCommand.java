...
public class RanksCommand implements CommandExecutor {
        ...
        if (sender instanceof Player) {
            ...
            if (player.hasPermission(ranksPermission)) {
                ...
                if (args.length == 0) {
                    ...
                    // Send the available ranks to the player, with clickable menus to get more information about each
                    // rank.
                    ...
                    UtilitiesOG.trueogMessage(player, "");
                    UtilitiesOG.trueogMessage(
                            player, "<green>Rank Overview: <dark_aqua><underlined>https://shop.true-og.net");
                    UtilitiesOG.trueogMessage(player, "");
                    UtilitiesOG.trueogMessage(
                            player,
                ...
                // If the player provided one or more arguments, do this...
                    ...
                    // If the "OG Pro" message was clicked, do this...
                        ...
                        UtilitiesOG.trueogMessage(
                                player, "- Use color codes in chat, mail, unions, signs, anvils, and book titles.");
                        ...
                        UtilitiesOG.trueogMessage(
                                player, "- Use 9 exclusive particle cosmetics with /cosmetics (up to 3 at once).");
                        UtilitiesOG.trueogMessage(player, "- &lMore TBA&r.");
    ...
    public static void sendClickableMessage(Player player, String command) {
        ...
        TextComponent clickableText =
                (TextComponent) MiniMessage.miniMessage().deserialize("<aqua><bold>Click here to see the benefits!");
