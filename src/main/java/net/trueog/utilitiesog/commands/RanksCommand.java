...
public class RanksCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        final String ranksPermission = "utilities.ranks";
        ...
        if (sender instanceof Player player) {
            ...
            if (player.hasPermission(ranksPermission)) {
                ...
                if (args.length == 0) {
                    ...
                    // Send the available ranks to the player, with clickable menus to get more
                    // information about each
                    // rank.
                    UtilitiesOG.trueogMessage(player,
                            "<bold><dark_purple>-=-=-=-=- <dark_green>True<dark_red>OG <aqua>Donation Store: <dark_purple>-=-=-=-=-");
                    UtilitiesOG.trueogMessage(player, "");
                    UtilitiesOG.trueogMessage(player, "Each donor rank requires the rank before it.");
                    UtilitiesOG.trueogMessage(player, "");
                    UtilitiesOG.trueogMessage(player,
                            "<green>Rank Overview: <dark_aqua><underlined>https://shop.true-og.net");
                    UtilitiesOG.trueogMessage(player, "");
                    UtilitiesOG.trueogMessage(player,
                            "<white>[OG] <gray>(<dark_green>$10 Once<gray>) <dark_aqua><underlined>https://true-og.net/og");
                    sendClickableMessage(player, "/ranks og");
                    UtilitiesOG.trueogMessage(player, "");
                    UtilitiesOG.trueogMessage(player,
                            "<red>[OG Pro] <gray>(<dark_green>$50 Once<gray>) <dark_aqua><underlined>https://true-og.net/og-pro");
                    sendClickableMessage(player, "/ranks og-pro");
                    UtilitiesOG.trueogMessage(player, "");
                    UtilitiesOG.trueogMessage(player,
                            "<dark_red><bold>[OG Master] <gray>(<gold>$10 Monthly<gray>) <dark_aqua><underlined>https://true-og.net/og-master");
                ...
                // If the player provided one or more arguments, do this...
                    ...
                    if (args[0].equalsIgnoreCase("og")) {
                        ...
                        // API.
                        UtilitiesOG.trueogMessage(player,
                                "<dark_purple><bold>-=-=-=-=- <dark_green>True<dark_red>OG <white>OG Rank: <dark_purple>-=-=-=-=-");
                        ...
                        UtilitiesOG.trueogMessage(player,
                                "- 6 homes (temporary benefit until the implementation of our in-game home earning plugin).");
                    ...
                    // If the "OG Pro" message was clicked, do this...
                        ...
                        // Message API.
                        UtilitiesOG.trueogMessage(player,
                                "<dark_purple><bold>-=-=-=-=- <dark_green>True&<dark_red>OG <red>OG Pro Rank: <dark_purple>-=-=-=-=-");
                        ...
                        UtilitiesOG.trueogMessage(player,
                                "- Use color codes in chat, mail, unions, signs, anvils, and book titles.");
                        ...
                        UtilitiesOG.trueogMessage(player,
                                "- Use 9 exclusive particle cosmetics with /cosmetics (up to 3 at once).");
                        UtilitiesOG.trueogMessage(player, "- &lMore TBA&r.");
                    ...
                    // If the "OG Master" message was clicked, do this...
                        ...
                        // Message API.
                        UtilitiesOG.trueogMessage(player,
                                "<dark_purple><bold>-=-=-=-=- <dark_green>True<dark_red>OG <dark_red>OG Master Rank: <dark_purple>-=-=-=-=-");
                        ...
                        UtilitiesOG.trueogMessage(player,
                                "- Special mail, sign, and anvil formatting (strike-through, italics, magic, etc).");
                        UtilitiesOG.trueogMessage(player, "- &lMore TBA&r.");
                ...
                // If the player specified too many command arguments, do this...
                    ...
                    UtilitiesOG.trueogMessage(player,
                            "<gray>[<dark_green>True<dark_red>OG<gray>] <red>ERROR: Too many arguments! <gold>Syntax: <yellow>/ranks");
    ...
    public static void sendClickableMessage(Player player, String command) {
        ...
        // Declare a TextComponent with pre-formatted contents using standard
        // MiniMessage APi.
        TextComponent clickableText = (TextComponent) MiniMessage.miniMessage()
                .deserialize("<aqua><bold>Click here to see the benefits!");
